...
一方，contrastive-frame group split は TF-IDF とルール特徴を大きく崩しており，修正後 pipeline の次評価として妥当である．
...
次の Colab A100 実験では，修正済み pipeline を用いて contrastive-frame group split 上で GPT-2 を再実行する．
